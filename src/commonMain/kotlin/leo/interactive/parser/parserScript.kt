...
val Letter.scriptLine: ScriptLine
  get() =
    "letter" lineTo script(char.toString())

val Digit.scriptLine: ScriptLine
  get() =
    "digit" lineTo script(literal(int))

val Word.scriptLine: ScriptLine
  get() =
    "word" lineTo script(
...
val TextItem.scriptLine: ScriptLine
  get() =
    "item" lineTo script(
      "text" lineTo script(
        when (this) {
...
val TextItemPrefix.scriptLine: ScriptLine
  get() =
...
val LiteralPrefix.scriptLine
  get() = "partial" lineTo script(
    when (this) {
...
val TextPrefix.scriptLine: ScriptLine
  get() =
    "prefix" lineTo script(
      "text" lineTo script(
        when (this) {
...
val TabPrefix.scriptLine: ScriptLine
  get() =
    "prefix" lineTo script(
      tab.scriptLine
    )

val End.scriptLine: ScriptLine
  get() =
    "end" lineTo script()

val Indent.scriptLine
  get() =
    "indent" lineTo script(
      tabStack.listScriptLine { scriptLine })

val IndentPrefix.scriptLine
  get() =
    "prefix" lineTo script(
      indent.scriptLine,
      "prefix" lineTo script(
...
val IndentSuffix.scriptLine
  get() =
    "suffix" lineTo script(indent.scriptLine)

val Header.scriptLine: ScriptLine
  get() =
...
val Comma.scriptLine: ScriptLine
  get() =
    "comma" lineTo script()

val Commable.scriptLine: ScriptLine
  get() =
...
val Spaceable.scriptLine: ScriptLine
  get() =
...
val Spaced.scriptLine: ScriptLine
  get() =
    "spaced" lineTo script(spaceable.scriptLine)

val Body.scriptLine: ScriptLine
  get() =
    "body" lineTo script(
      indent.scriptLine,
      commable.scriptLine
...
val Token.scriptLine: ScriptLine
  get() =
    "token" lineTo script(
      when (this) {
...
val NameBegin.scriptLine: ScriptLine
  get() =
    "begin" lineTo script(name)

val Tokens.scriptLine: ScriptLine
  get() =
    "token" lineTo script(
      tokenStack.listScriptLine { scriptLine })

val TokensPrefix.scriptLine: ScriptLine
  get() =
    "partial" lineTo script(
      tokens.scriptLine,
      line.scriptLine
