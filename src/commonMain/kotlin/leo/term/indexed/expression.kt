...
data class ExpressionIndexed<out V>(val index: Int, val expression: Expression<V>)
...
fun <V> indexed(index: Int, expression: Expression<V>) = ExpressionIndexed(index, expression)
fun <V> indexSwitch(lhs: Expression<V>, vararg cases: Expression<V>) = ExpressionSwitch(lhs, listOf(*cases))
