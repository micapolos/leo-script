...
data class TermAbstraction(val variable: TermVariable, val term: Term)
...
fun TermVariable.does(term: Term): Term = term(TermAbstraction(this, term))
fun Term.give(term: Term): Term = term(TermApplication(this, term))
