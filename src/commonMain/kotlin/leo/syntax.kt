...
data class Matching(val type: Type)
...
fun matching(type: Type) = Matching(type)
fun not(syntax: Syntax) = Not(syntax)
fun let(type: Type, be: Be) = Let(type, BeLetRhs(be))
fun let(type: Type, do_: Do) = Let(type, DoLetRhs(do_))
