...
data class Repeat(val atomOrNull: SyntaxAtom?)
data class Recurse(val atomOrNull: SyntaxAtom?)
data class Repeating(val syntax: Syntax)
...
fun recurse(atomOrNull: SyntaxAtom?) = Recurse(atomOrNull)
fun repeat(atomOrNull: SyntaxAtom?) = Repeat(atomOrNull)
fun repeating(syntax: Syntax) = Repeating(syntax)
