...
@JvmInline value class As(val syntax: Syntax)
@JvmInline value class Be(val syntax: Syntax)
@JvmInline value class Bind(val syntax: Syntax)
@JvmInline value class End(val syntax: Syntax)
@JvmInline value class Check(val is_: Is)
@JvmInline value class Comment(val script: Script)
@JvmInline value class Do(val block: Block)
@JvmInline value class Doing(val block: Block)
@JvmInline value class Equal(val syntax: Syntax)
@JvmInline value class Example(val syntax: Syntax)
@JvmInline value class Fail(val syntax: Syntax)
@JvmInline value class Get(val nameStack: Stack<String>)
@JvmInline value class Give(val syntax: Syntax)
data class Is(val rhs: IsRhs, val negated: Boolean)
data class Let(val syntax: Syntax, val rhs: LetRhs)
@JvmInline value class Repeat(val syntax: Syntax)
@JvmInline value class Matching(val syntax: Syntax)
@JvmInline value class Not(val syntax: Syntax)
@JvmInline value class Private(val syntax: Syntax)
@JvmInline value class Recurse(val syntax: Syntax)
@JvmInline value class Recursing(val syntax: Syntax)
@JvmInline value class Quote(val script: Script)
@JvmInline value class Set(val atomStack: Stack<SyntaxAtom>)
@JvmInline value class Take(val syntax: Syntax)
data class Test(val lhsSyntax: Syntax, val is_: Is)
@JvmInline value class Try(val syntax: Syntax)
@JvmInline value class Update(val fieldStack: Stack<SyntaxField>)
@JvmInline value class With(val syntax: Syntax)
