...
@kotlin.jvm.JvmInline value class Applying(val block: Block)
@kotlin.jvm.JvmInline value class As(val syntax: Syntax)
@kotlin.jvm.JvmInline value class Be(val syntax: Syntax)
@kotlin.jvm.JvmInline value class Being(val syntax: Syntax)
@kotlin.jvm.JvmInline value class Check(val is_: Is)
@kotlin.jvm.JvmInline value class Comment(val script: Script)
@kotlin.jvm.JvmInline value class CombineWith(val block: Block)
@kotlin.jvm.JvmInline value class CombiningWith(val block: Block)
@kotlin.jvm.JvmInline value class Debug(val script: Script)
...
@kotlin.jvm.JvmInline value class Have(val syntax: Syntax)
@kotlin.jvm.JvmInline value class Help(val script: Script)
...
@kotlin.jvm.JvmInline value class The(val atomStack: Stack<SyntaxAtom>)
