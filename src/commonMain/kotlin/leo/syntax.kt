...
@kotlin.jvm.JvmInline value class Apply(val syntax: Syntax)
@kotlin.jvm.JvmInline value class Applying(val syntax: Syntax)
...
fun apply(syntax: Syntax) = Apply(syntax)
fun applying(syntax: Syntax) = Applying(syntax)
